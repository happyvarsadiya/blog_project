...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="password.php" class="nav-link">Change Password</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
     ...
     <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="image/admin/<?php echo @$data['s_image']; ?>" class="img-circle elevation-2">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add_others.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Others</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="view_others.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Others</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add_clients.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Clients</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add_blog-grid.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Blog-Grid</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="view_blog-grid.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Blog-Grid</p>
                </a>
              </li>
